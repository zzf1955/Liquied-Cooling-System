...
class SingleBattery:
    def __init__(self, 
                 ...
                 # 环境参数
                 env_temperature=294.0,    # 环境温度 (K)
                 flow_rate= 3 ,            # 冷却液流速 (m/s)
        ...
        self.inlet_temp = inlet_temp  # 使用inlet_temp跟踪冷却液温度
    ...
    #     print(f"对流换热系数：{Nu * self.coolant_conductivity / dh}")
        
    #     return 3 * Nu * self.coolant_conductivity / dh
